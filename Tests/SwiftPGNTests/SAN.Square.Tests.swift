...
final class SANSquareTests: XCTestCase {
    ...
    Nf2 42. g4 Bd3 43. Qh4xe1 1/2-1/2
    """

    func test_Matches() {

//
//        let pawnMove = #"[a-h][1-8]"#
//
//        let castleKing = #"O-O"#
//        let castleQueen = #"O-O-O"#
//        let pawnCapture = #"[a-h][a-h][1-8]"#
//        let moveFile = #"[BNRQK][a-h][a-h][1-8]"#
//        let moveRank = #"[BNRQK][1-8][a-h][1-8]"#
//        let promotion =  #"[a-h][1-8]=[BNRQ]"#
//        let promCapture = #"[a-h][a-h][1-8][BNRQ]"#

        let move = #"([BNRQK]?[a-h]?)([a-h][1-8])(x([a-h][1-8]))?"#

        var sut = "Qh4xe1".matches(withPattern: move)
